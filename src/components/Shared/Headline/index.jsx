...
const Headline = ({ headlineData }) => {
    ...
    return (
        <div className="flex gap-4 h-16 w-full bg-lightYellowColor justify-center font-medium items-center uppercase text-[5vw] sm:text-[4vw] md:text-[3vw] 2xl:text-4xl overflow-hidden" id="pageStart">
            {
