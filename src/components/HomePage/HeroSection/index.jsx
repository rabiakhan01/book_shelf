...
const HeroSection = () => {
    return (
        <div>
            <div className="flex justify-center items-center mt-2 xl:mt-4">
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full">
                ...
                <div className="relative flex flex-col gap-4 justify-between w-full md:w-1/2 bg-secondaryColor p-4 small-tab:h-56 md:h-auto sm:h-64 rounded-xl">
                    <div className="flex flex-col gap-5">
                        ...
                        <p className="text-textLightWhiteColor text-sm small-tab:text-base sm:text-lg w-2/3 xl:w-1/2">Fancy something unusual and unpredictable? Funny or exciting? No problem. Check out the collections we have prepared for you.</p>
                    </div>
                    <div>
                        <Button
                            variant="outlined"
